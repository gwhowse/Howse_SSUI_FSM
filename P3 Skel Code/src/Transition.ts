...
export class Transition {
    ...
    public match(evtType : EventType, regn? : Region) : boolean {
        ...
        // **** YOUR CODE HERE ****
        // We just need to be checking that the given evtType and regn match our onEvent
        if (regn) return this.onEvent.match(evtType, regn);
        else return this.onEvent.match(evtType);
    }
    ...
    public bindTarget(stateList : readonly State[]) : void {
        ...
        // **** YOUR CODE HERE ****
        // loop through our list of states, if our target name matches a states's name, set target and we're done.
