...
export class Region {
    ...
    public pick(localX : number, localY : number) : boolean {
        ...
        // **** YOUR CODE HERE ****
        // check if 0<=x<=w and 0<=y<=h
        let xInBounds : boolean = (localX >= 0) && (localX <= this.w);
        let yInBounds : boolean = (localY >= 0) && (localY <= this.h);
    ...
    public damage() {
        ...
        // **** YOUR CODE HERE ****
        // pass damage up to our parent if we have one
        this.parent?.damage();
    }
